...
public class CommonDaoTest extends DaoTestApi {
    ...
    public void getAdministratorTypeByUserId() {
        final var administrator = new Administrator("KylieMccalpin345", "qXRf0ujqF501",
    ...
    public void getPatientTypeByUserId() {
        final var patient = new Patient("CasenTurns398", "yC6JZ7YHqd6F",
    ...
    public void getDoctorTypeByUserId() {
        final var doctor = new Doctor("RoudiKarpov62", "EaGV1fBkLxrX",
